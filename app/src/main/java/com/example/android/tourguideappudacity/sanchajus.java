    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                skamb();
                String str_location = getApplicationContext().getString(R.string.SanchajusAddres);
        ...
        tel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                skamb();
                String phone = getApplicationContext().getString(R.string.SanchajusTelNr);
        ...
        googlesearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                skamb();
                String daugiau = getApplicationContext().getString(R.string.SanchajusUrl);
